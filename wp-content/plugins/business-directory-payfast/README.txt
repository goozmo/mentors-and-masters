=== Business Directory Plugin - PayFast Gateway ===
...
== Description ==
This plugins add support for PayFast as a payment method in Business Directory Plugin.
...
Version 3.5.1
- Do not show the PayFast currency warning when PayFast is not actually enabled. 
