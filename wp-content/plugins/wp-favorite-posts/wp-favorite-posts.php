...
function wpfp_init() {
    $wpfp_options = array();
    $wpfp_options['add_favorite'] = "Add to wishlist";
    $wpfp_options['added'] = "Added to wishlist!";
    $wpfp_options['remove_favorite'] = "Remove from wishlist";
    $wpfp_options['removed'] = "Removed from wishlist!";
    $wpfp_options['clear'] = "Clear wishlist";
    $wpfp_options['cleared'] = "<p>Wishlist cleared!</p>";
    $wpfp_options['favorites_empty'] = "Wishlist is empty.";
    ...
    $wpfp_options['text_only_registered'] = "Only registered users can wishlist!";
